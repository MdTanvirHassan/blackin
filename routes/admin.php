...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        Route::get('/group-product-categories', 'groupProductCategoriesIndex')->name('group-product-categories.index');
        Route::get('/group-product-categories/create', 'groupProductCategoriesCreate')->name('group-product-categories.create');
        Route::post('/group-product-categories/store', 'groupProductCategoriesStore')->name('group-product-categories.store');
        Route::get('/group-product-categories/edit/{id}', 'groupProductCategoriesEdit')->name('group-product-categories.edit');
        Route::post('/group-product-categories/update/{id}', 'groupProductCategoriesUpdate')->name('group-product-categories.update');
        Route::get('/group-product-categories/destroy/{id}', 'groupProductCategoriesDestroy')->name('group-product-categories.destroy');
        Route::post('/group-product-categories/featured', 'groupProductCategoriesUpdateFeatured')->name('group-product-categories.featured');
        Route::post('/group-product-categories/update-active', 'groupProductCategoriesUpdateActive')->name('group-product-categories.update_active');
    });
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        // Group Product
        Route::get('/group-products', 'group_products_index')->name('group_products.index');
        Route::get('/group-products/create', 'group_product_create')->name('group_products.create');
        Route::post('/group-products/store', 'group_product_store')->name('group_products.store');
        Route::get('/group-products/edit/{id}', 'group_product_edit')->name('group_products.edit');
        Route::post('/group-products/update/{id}', 'group_product_update')->name('group_products.update');
        Route::get('/group-products/destroy/{id}', 'group_product_destroy')->name('group_products.destroy');
        Route::post('/group-products/update-published', 'group_product_update_published')->name('group_products.update_published');
    });
    ...
    Route::controller(DivisionController::class)->group(function () {
        ...
        Route::post('/division/status', 'updateStatus')->name('division.status');
    });

    Route::resource('district', DistrictController::class);
    Route::controller(DistrictController::class)->group(function () {
        Route::get('/district/edit/{id}', 'edit')->name('district.edit');
        Route::post('/district/status', 'updateStatus')->name('district.status');
    });
    // States
