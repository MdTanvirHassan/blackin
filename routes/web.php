...
Route::get('/bundles/{identifier}', [ProductController::class, 'group_product_show'])->name('group_products.show');
Route::post('/bundles/{identifier}/add-to-cart', [ProductController::class, 'group_product_add_to_cart'])->name('group_products.add_to_cart');
Route::get('/group-products/category/{category_slug}', [ProductController::class, 'group_products_by_category'])->name('group_products.category');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/cart/removeGroupProductFromCart', 'removeGroupProductFromCart')->name('cart.removeGroupProductFromCart');
...
Route::group(['prefix' => 'checkout'], function () {
    Route::controller(CheckoutController::class)->group(function () {
        ...
        Route::get('/single_page_checkout', 'single_page_checkout')->name('checkout.single_page_checkout');
        ...
        Route::post('/shipment', 'shipment')->name('checkout.shipment');
        Route::post('/store-shipping-payment', 'store_shipping_payment')->name('checkout.store_shipping_payment');
...
Route::controller(AddressController::class)->group(function () {
    ...
    Route::post('/addresses/make-default/{id}', 'makeDefault')->name('addresses.make_default');
    Route::post('/get-district', 'getDistrict')->name('get-district');
});
