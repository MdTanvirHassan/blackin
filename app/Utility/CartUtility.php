...
class CartUtility
{
    ...
    public static function get_price($product, $product_stock, $quantity, $skipIndividualDiscount = false)
    {
        ...
        $price = self::discount_calculation($product, $price, $skipIndividualDiscount);
        return $price;
    }

    public static function discount_calculation($product, $price, $skipIndividualDiscount = false)
    {
        if ($skipIndividualDiscount) {
            return $price;
        }
