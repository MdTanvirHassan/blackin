...
class BkashController extends Controller
{
    ...
    public function pay()
    {
        ...
        if (Session::has('payment_type')) {
            ...
            } elseif ($paymentType == 'shipping_fee_payment') {
                $amount = round($paymentData['amount']);
            }
        }
    ...
    public function success(Request $request)
    {
        ...
        elseif ($payment_type == 'shipping_fee_payment') {
            return (new CheckoutController)->shipping_fee_payment_done($paymentData, Session::get('payment_details'));
        }
    }
}
