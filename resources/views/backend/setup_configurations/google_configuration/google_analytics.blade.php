...
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('google_analytics.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="TRACKING_ID" value="{{  env('TRACKING_ID') }}" placeholder="{{ translate('Tracking ID (e.g., G-XXXXXXXXXX)') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
        ...
        <div class="col-md-6">
            <div class="card bg-gray-light">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Please be carefull when you are configuring Google Analytics.') }}</h5>
                </div>
                <div class="card-body">
                    <ul class="list-group mar-no">
                        <li class="list-group-item text-dark">1. {{ translate('Log in to your Google Analytics account') }}.</li>
                        <li class="list-group-item text-dark">2. {{ translate('Go to Admin > Data Streams and select your website') }}.</li>
                        <li class="list-group-item text-dark">3. {{ translate('Copy your Measurement ID (G-XXXXXXXXXX) and paste it into Tracking ID field') }}.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('google_tag_manager.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="GOOGLE_TAG_MANAGER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('GTM Container ID')}}</label>
                            </div>
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="GOOGLE_TAG_MANAGER_ID" value="{{  env('GOOGLE_TAG_MANAGER_ID') }}" placeholder="{{ translate('GTM-XXXXXXX') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
        ...
        <div class="col-md-6">
            <div class="card bg-gray-light">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Please be carefull when you are configuring Google Tag Manager.') }}</h5>
                </div>
                <div class="card-body">
                    <ul class="list-group mar-no">
                        <li class="list-group-item text-dark">1. {{ translate('Log in to your Google Tag Manager account') }}.</li>
                        <li class="list-group-item text-dark">2. {{ translate('Click on the container you want to use') }}.</li>
                        <li class="list-group-item text-dark">3. {{ translate('Copy your Container ID (GTM-XXXXXXX) from the top right corner and paste it into GTM Container ID field') }}.</li>
                        <li class="list-group-item text-dark">4. {{ translate('Note: GTM will be installed in the head section and right after the opening body tag') }}.</li>
                    </ul>
                </div>
            </div>
        </div>
