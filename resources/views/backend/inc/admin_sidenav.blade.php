                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @can('add_new_group_product')
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link {{ areActiveRoutes(['group_products.index', 'group_products.create', 'group_products.edit']) }}" href="{{route('group_products.index')}}">
                            ...
                            @can('view_product_categories')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('group-product-categories.index')}}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['group-product-categories.index', 'group-product-categories.create', 'group-product-categories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Group Product Category')}}</span>
                                </a>
                            </li>
                            @endcan
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @endcan -->
                                @can('manage_shipping_division')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('division.index')}}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['division.index','division.edit','division.update'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Shipping Divisions')}}</span>
                                    </a>
                                </li>
                                @endcan
                                @can('manage_shipping_district')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('district.index')}}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['district.index','district.edit','district.update'])}}">
