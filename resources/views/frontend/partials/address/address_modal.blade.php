            ...
            <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <input type="hidden" name="country_id" id="country_id" value="{{get_active_countries()[0]->id }}">
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select Division') }}" name="division_id" id="division_id" required>
                                        <option value="">{{ translate('Select Division') }}</option>
                                        @foreach (\App\Models\Division::where('status', 1)->orderBy('name')->get() as $division)
                                        <option value="{{ $division->id }}">{{ $division->getTranslation('name') }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select District') }}" name="district_id" id="district_id" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="state_id" id="state_id">
