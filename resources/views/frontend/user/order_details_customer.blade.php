                        ...
                        <tr>
                            ...
                            <td>
                                @if ($order->user_id != null)
                                    {{ $order->user->email }}
                                @elseif($shipping_address && isset($shipping_address->email))
                    ...
                    <table class="aiz-table table">
                        ...
                        <tbody class="fs-14">
                            ...
                            @foreach ($groupedDetails as $hash => $group)
                                ...
                                <tr class="bg-light">
                                    <td class="pl-0 fw-600">{{ sprintf('%02d', ++$itemCounter) }}</td>
                                    <td class="fw-600" colspan="4">
                                    ...
                                    <td class="fw-700 text-right">{{ single_price($groupTotalPrice) }}</td>
                                    @if (addon_is_activated('refund_request'))
                            ...
                            @foreach ($ungroupedDetails as $orderDetail)
                                <tr>
                                    <td class="pl-0">{{ sprintf('%02d', ++$itemCounter) }}</td>
                                    <td>
                                        @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                            <a href="{{ route('product', $orderDetail->product->slug) }}"
                                                target="_blank">{{ $orderDetail->product->getTranslation('name') }}</a>
