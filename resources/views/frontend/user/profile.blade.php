    ...
    <div class="card-body">
        ...
        <div class="">
            <div class="border p-4 mb-4 position-relative">
                ...
                @if ($address->division)
                <div class="row fs-14 mb-2 mb-md-0">
                    <span class="col-md-2 text-secondary">{{ translate('Division') }}:</span>
                    <span class="col-md-10 text-dark">{{ $address->division->getTranslation('name') }}</span>
                </div>
                @endif
                @if ($address->district)
                <div class="row fs-14 mb-2 mb-md-0">
                    <span class="col-md-2 text-secondary">{{ translate('District') }}:</span>
                    <span class="col-md-10 text-dark">{{ $address->district->getTranslation('name') }}</span>
                </div>
                @endif
                <div class="row fs-14 mb-2 mb-md-0">
