<div class="text-left">
    ...
    <div class="d-flex flex-wrap align-items-center">
        ...
        @if($sizeChartId != 0)
            <div class="ml-4">
                <a href="javascript:void(1);" onclick='showSizeChartDetail({{ $sizeChartId }}, "{{ $sizeChartName }}")' class="btn btn-dark btn-sm px-3 py-1 text-white">{{ translate('Show size guide') }}</a>
            </div>
        @endif
    </div>
