        ...
        <div class="custom-container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between bg-white p-3 rounded-lg shadow-sm">
                ...
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0 d-flex align-items-center">
                    <i class="las la-shopping-bag text-primary mr-2"></i>
            ...
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-2 position-relative has-transition bg-light gap-2 @if($key == 0) border-left @endif hov-animate-outlinex">
