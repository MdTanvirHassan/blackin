@if (count(get_featured_products()) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="mx-md-0 mx-1">
            <!-- Top Section -->
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between bg-white p-3 rounded-lg shadow-sm">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0 d-flex align-items-center">
                    <i class="las la-star text-primary mr-2"></i>
            ...
            <div class="px-sm-3">
                <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box position-relative px-0 has-transition hov-animate-outlinex  bg-light gap-2  @if($key == 0) border-left @endif">
                        <div class="px-2">
