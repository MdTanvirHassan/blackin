...
<style>
    ...
    .ascolour-mega-menu.show {
        opacity: 1;
        visibility: visible;
        pointer-events: auto;
    }
    
    .ascolour-mega-wrapper {
        max-width: 1400px;
        margin: 0 auto;
        padding: 40px 20px;
    }
    ...
    .ascolour-category-item {
        display: flex;
        flex-direction: column;
        gap: 12px;
    }
    
    .ascolour-category-item > a {
        text-decoration: none;
        color: inherit;
    }
    
    .ascolour-parent-category {
        display: flex;
        align-items: center;
        gap: 12px;
        padding: 8px 0;
    ...
    .ascolour-parent-category:hover .ascolour-category-image-small {
        transform: scale(1.1);
        box-shadow: 0 4px 12px rgba(184, 134, 11, 0.4);
    }
    
    .ascolour-child-category-item {
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
    ...
    .ascolour-child-category-item:hover {
        background: rgba(64, 64, 64, 0.3);
        padding-left: 12px;
        text-decoration: none;
    }
    
    .ascolour-child-category-item:hover span {
        color: #fff !important;
    }
    
    .ascolour-child-category-item:hover .ascolour-child-category-image {
        transform: scale(1.05);
        box-shadow: 0 2px 8px rgba(184, 134, 11, 0.4);
    }
    
    .ascolour-child-category-image {
        width: 32px;
        height: 32px;
        object-fit: cover;
        border-radius: 3px;
    ...
    .ascolour-parent-category:hover .ascolour-column-title {
        color: #b8860b;
    }
    ...
    .ascolour-mega-column .ascolour-column-title::after {
        content: '.';
        color: #b8860b;
    }
    ...
    .ascolour-subcategory-list {
        padding-left: 0;
        margin-top: 8px;
    }
    
    .ascolour-subcategory-list li {
        margin-bottom: 8px;
    }
    
    .ascolour-subcategory-list a {
        color: #999;
        font-size: 14px;
        text-decoration: none;
        transition: all 0.2s ease;
    ...
    .ascolour-subcategory-list a:hover {
        color: #b8860b;
        padding-left: 8px;
        text-decoration: none;
    }
    
    .ascolour-subcategory-list a.animate-underline-primary::after {
        background-color: #b8860b;
    }
    
    /* Nested Subcategory List Styles */
    .ascolour-subcategory-list ul {
        padding-left: 15px;
        margin-top: 8px;
    ...
    .ascolour-subcategory-list ul li a {
        color: #999;
        font-size: 13px;
        transition: all 0.2s ease;
    }
    
    .ascolour-subcategory-list ul li a:hover {
        color: #b8860b;
        padding-left: 6px;
    }
    
    .ascolour-subcategory-list > li > a {
        font-weight: 700;
        color: #ccc;
        font-size: 14px;
    }
    
    .ascolour-subcategory-list > li > a:hover {
        color: #b8860b;
    }
    ...
    @media (max-width: 991px) {
        ...
        .ascolour-child-category-item span {
    ...
    /* Utility Nav Icon Hover Effects */
    .utility-nav-icon {
        transition: all 0.2s ease;
    }
    
    .utility-nav-icon:hover .utility-icon-svg path,
    .utility-nav-icon:hover .utility-icon-svg {
    ...
    /* For cart icon which uses currentColor */
    .utility-nav-icon:hover svg {
        color: #b8860b !important;
    }
    ...
    @media (max-width: 767px) {
        ...
        .logo-bar-area .col-auto.d-md-none {
            position: absolute;
            left: 50%;
        ...
        .logo-bar-area .col-auto.d-md-none a {
            padding: 20px 0 !important;
            margin: 0 !important;
        }
        
        .logo-bar-area button[data-target=".aiz-top-menu-sidebar"] {
            position: relative;
            z-index: 2;
        }
        
        .logo-bar-area .d-lg-none.ml-auto {
            position: relative;
            z-index: 2;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const navBar = document.querySelector('.ascolour-dark-nav');
    ...
    navItems.forEach(item => {
        ...
        if (megaMenu) {
            ...
            item.addEventListener('mouseenter', function() {
                ...
                // Hide any other open menu immediately
    ...
    window.addEventListener('scroll', function() {
        if (currentMegaMenu) {
            positionMegaMenu(currentMegaMenu);
        }
    });
            ...
            <div class="d-flex align-items-center">
                ...
                @if (Auth::check() && auth()->user()->user_type == 'customer')
                    ...
                    <ul class="list-inline mb-0 h-100 d-none d-xl-flex justify-content-end align-items-center">
                        <li class="list-inline-item ml-3 mr-3 pr-3 pl-0 dropdown" id="notification-dropdown">
    ...
    <nav class="ascolour-dark-nav bottom-background-color-visibility" style="background-color: {{ get_setting('bottom_header_bg_color') }}">
        <div class="ascolour-nav-container" >
            ...
            <ul class="ascolour-main-nav aiz-category-menu">
                @php
                    $mainCategories = \App\Models\Category::with(['childrenCategories.childrenCategories'])->where('level', 0)->orderBy('order_level', 'desc')->take(2)->get();
                @endphp
                ...
                @foreach ($mainCategories as $category)
                    <li class="ascolour-nav-item">
                        ...
                        <!-- Mega Menu Dropdown -->
                        @php
                            $categoryChildren = $category->childrenCategories ?? collect();
                        @endphp
                        @if ($categoryChildren->count() > 0)
                            <div class="ascolour-mega-menu">
                                <div class="ascolour-mega-wrapper">
                                    <div class="ascolour-mega-content">
                                        @foreach($categoryChildren as $childCategory)
                                            <div class="ascolour-category-item">
                                                <!-- Parent Category with Image -->
                                                <a href="{{ route('products.category', $childCategory->slug) }}" class="ascolour-parent-category">
                                                    @if($childCategory->banner)
                                                        <img src="{{ uploaded_asset($childCategory->banner) }}" 
                                                             alt="{{ $childCategory->getTranslation('name') }}"
                                                             class="ascolour-category-image-small"
                                                             onerror="this.src='{{ static_asset('assets/img/placeholder.jpg') }}'">
                                                    @else
                                                        <div class="ascolour-category-image-small" style="background: linear-gradient(135deg, #404040 0%, #2b2b2b 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 20px; font-weight: bold;">
                                                            {{ substr($childCategory->getTranslation('name'), 0, 1) }}
                                                        </div>
                                                    @endif
                                                    <h3 class="ascolour-column-title" style="margin: 0;">
                                                        {{ $childCategory->getTranslation('name') }}
                                                    </h3>
                                                </a>
                                                
                                                <!-- Child Categories with Images -->
                                                @php
                                                    $subCategoryChildren = $childCategory->childrenCategories ?? collect();
                                                @endphp
                                                @if ($subCategoryChildren->count() > 0)
                                                    <div>
                                                        @foreach($subCategoryChildren->take(6) as $subCategory)
                                                            <a href="{{ route('products.category', $subCategory->slug) }}" class="ascolour-child-category-item">
                                                                @if($subCategory->banner)
                                                                    <img src="{{ uploaded_asset($subCategory->banner) }}" 
                                                                         alt="{{ $subCategory->getTranslation('name') }}"
                                                                         class="ascolour-child-category-image"
                                                                         onerror="this.src='{{ static_asset('assets/img/placeholder.jpg') }}'">
                                                                @else
                                                                    <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                                                        {{ substr($subCategory->getTranslation('name'), 0, 1) }}
                                                                    </div>
                                                                @endif
                                                        ...
                                                        @endforeach
                                                        @if($subCategoryChildren->count() > 6)
                                                            <a href="{{ route('products.category', $childCategory->slug) }}" class="ascolour-child-category-item" style="color: #b8860b;">
                                                                <span style="margin-left: 42px; font-weight: 600;">
                                                                    {{ translate('View All') }} ({{ $subCategoryChildren->count() }}) →
                                                                </span>
                                                            </a>
                                                        @endif
                                                    </div>
                ...
                <li class="ascolour-nav-item">
                    ...
                    <div class="ascolour-mega-menu">
                        <div class="ascolour-mega-wrapper">
                            <div class="ascolour-mega-content">
                                @php
                                    $allCategories = \App\Models\Category::with(['childrenCategories.childrenCategories'])->where('parent_id', 0)->orderBy('order_level', 'desc')->get();
                                @endphp
                                
                                @foreach($allCategories as $mainCategory)
                                    <div class="ascolour-category-item">
                                        <!-- Parent Category with Image -->
                                        <a href="{{ route('products.category', $mainCategory->slug) }}" class="ascolour-parent-category">
                                            @if($mainCategory->banner)
                                                <img src="{{ uploaded_asset($mainCategory->banner) }}" 
                                                     alt="{{ $mainCategory->getTranslation('name') }}"
                                                     class="ascolour-category-image-small"
                                                     onerror="this.src='{{ static_asset('assets/img/placeholder.jpg') }}'">
                                            @else
                                                <div class="ascolour-category-image-small" style="background: linear-gradient(135deg, #404040 0%, #2b2b2b 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 20px; font-weight: bold;">
                                                    {{ substr($mainCategory->getTranslation('name'), 0, 1) }}
                                                </div>
                                            @endif
                                            <h3 class="ascolour-column-title" style="margin: 0;">
                                        ...
                                        <!-- Child Categories with Images -->
                                        @php
                                            $mainCategoryChildren = $mainCategory->childrenCategories ?? collect();
                                        @endphp
                                        @if ($mainCategoryChildren->count() > 0)
                                            <div>
                                                @foreach($mainCategoryChildren->take(6) as $childCategory)
                                                    <a href="{{ route('products.category', $childCategory->slug) }}" class="ascolour-child-category-item">
                                                        @if($childCategory->banner)
                                                            <img src="{{ uploaded_asset($childCategory->banner) }}" 
                                                                 alt="{{ $childCategory->getTranslation('name') }}"
                                                                 class="ascolour-child-category-image"
                                                ...
                                                @endforeach
                                                @if($mainCategoryChildren->count() > 6)
                                                    <a href="{{ route('products.category', $mainCategory->slug) }}" class="ascolour-child-category-item" style="color: #b8860b;">
                                                        <span style="margin-left: 42px; font-weight: 600;">
                                                            {{ translate('View All') }} ({{ $mainCategoryChildren->count() }}) →
                                                        </span>
                                                    </a>
                                                @endif
                                            </div>
                            ...
                            <div class="ascolour-mega-content">
                                ...
                                <div class="ascolour-category-item">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('returnpolicy') }}" class="ascolour-child-category-item">
                                            <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                        ...
                                        <a href="{{ route('supportpolicy') }}" class="ascolour-child-category-item">
                                            <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                        ...
                                        <a href="{{ route('privacypolicy') }}" class="ascolour-child-category-item">
                                            <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                    ...
                                    <div>
                                        @if ( get_setting('show_social_links') )
                                            @if (!empty(get_setting('instagram_link')))
                                                <a href="{{ get_setting('instagram_link') }}" target="_blank" class="ascolour-child-category-item">
                                                    <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                            ...
                                            @if (!empty(get_setting('facebook_link')))
                                                <a href="{{ get_setting('facebook_link') }}" target="_blank" class="ascolour-child-category-item">
                                                    <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                            ...
                                            @if (!empty(get_setting('twitter_link')))
                                                <a href="{{ get_setting('twitter_link') }}" target="_blank" class="ascolour-child-category-item">
                                                    <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
                                            ...
                                            @if (!empty(get_setting('youtube_link')))
                                                <a href="{{ get_setting('youtube_link') }}" target="_blank" class="ascolour-child-category-item">
                                                    <div class="ascolour-child-category-image" style="background: linear-gradient(135deg, #555 0%, #404040 100%); display: flex; align-items: center; justify-content: center; color: #b8860b; font-size: 14px; font-weight: bold;">
            ...
            <ul class="ascolour-utility-nav">
                <li><a href="#" onclick="toggleSearch(); return false;" class="utility-nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" class="utility-icon-svg">
                        <path d="M9.847,17.839a7.993,7.993,0,1,1,7.993-7.993A8,8,0,0,1,9.847,17.839Zm0-14.387a6.394,6.394,0,1,0,6.394,6.394A6.4,6.4,0,0,0,9.847,3.453Z" transform="translate(-1.854 -1.854)" fill="#fff"/>
                        <path d="M24.4,25.2a.8.8,0,0,1-.565-.234l-6.15-6.15a.8.8,0,0,1,1.13-1.13l6.15,6.15A.8.8,0,0,1,24.4,25.2Z" transform="translate(-5.2 -5.2)" fill="#fff"/>
                    </svg></a></li>
                 ...
                 @auth
                 <ul class="list-inline mb-0 h-100 d-none d-xl-flex justify-content-end align-items-center">
                        <li class="list-inline-item ml-0 mr-0 pr-0 pl-0 dropdown" id="notification-dropdown-utility">
                            <a class="dropdown-toggle no-arrow text-secondary fs-12 utility-nav-icon" data-toggle="dropdown"
                                href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                                <span class="position-relative d-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14.668" height="16"
                                        viewBox="0 0 14.668 16" class="utility-icon-svg">
                                        <path id="_26._Notification" data-name="26. Notification"
                                            d="M8.333,16A3.34,3.34,0,0,0,11,14.667H5.666A3.34,3.34,0,0,0,8.333,16ZM15.06,9.78a2.457,2.457,0,0,1-.727-1.747V6a6,6,0,1,0-12,0V8.033A2.457,2.457,0,0,1,1.606,9.78,2.083,2.083,0,0,0,3.08,13.333H13.586A2.083,2.083,0,0,0,15.06,9.78Z"
                                            transform="translate(-0.999)" fill="#91919b" />
                                    </svg>
                ...
                @auth
                    <li class="ascolour-user-dropdown position-relative">
                        ...
                        <a href="javascript:void(0);" class="d-flex align-items-center utility-nav-icon">
                        <span class="d-flex align-items-center nav-user-info py-20px @if (isAdmin()) ml-0 @endif"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="ml-2 utility-icon-svg">
...
<script>
    // Handle notification dropdown - call nonLinkableNotificationRead when dropdown is shown
    $(document).ready(function() {
        // Handle both notification dropdowns
        $('#notification-dropdown, #notification-dropdown-utility').on('show.bs.dropdown', function(e) {
            // Call the function when dropdown is about to show
            if (typeof nonLinkableNotificationRead === 'function') {
                try {
                    nonLinkableNotificationRead();
                } catch(error) {
                    console.error('Error calling nonLinkableNotificationRead:', error);
                }
            }
        });
    });
